      ...
      <div class="wrap${this._displayMode ? " display-mode" : ""}${this._replyMode ? " reply-mode" : ""}">
        ...
        <div class="layout">
          <main class="card soft">
            ...
            <div class="reply-help">Tap one of the reply buttons below. Google/Nest displays usually do not expose a reliable keyboard or microphone to casted Home Assistant dashboards.</div>
