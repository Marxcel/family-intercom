        ...
        <div class="layout">
          <main class="card soft">
            ...
            <div class="voice-commands">
              <div class="voice-command">Hey Google, turn on Intercom Reply Yes</div>
              <div class="voice-command">Hey Google, turn on Intercom Reply No</div>
              <div class="voice-command">Hey Google, turn on Intercom Reply Okay</div>
              <div class="voice-command">Hey Google, turn on Intercom Reply Coming</div>
              <div class="voice-command">Hey Google, turn on Intercom Reply Need Help</div>
              <div class="voice-command">Hey Google, turn on Intercom Reply Call Me</div>
            </div>
