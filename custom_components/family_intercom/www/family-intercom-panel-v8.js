    ...
    this.innerHTML = `
      <style>
        ...
        *{box-sizing:border-box}
        ...
        .reply-mode .target-row,.reply-mode #favoriteChips,.reply-mode #presetChips,.reply-mode #targetChips,.reply-mode aside,.reply-mode #saveQuick,.reply-mode #emergency,.reply-mode #displayMode{display:none!important}
